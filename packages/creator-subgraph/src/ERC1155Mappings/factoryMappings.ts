...
const DRAKULA_CREATOR = "0xed518109111780da7fcc1b765b80eb09d67ad5a7";
const DRAKULA_CREATOR_ADDRESS = Address.fromString(DRAKULA_CREATOR);

export function handleNewContractCreated(event: SetupNewContract): void {

  if (event.params.defaultAdmin.notEqual(DRAKULA_CREATOR_ADDRESS)) {
    return;
  }
